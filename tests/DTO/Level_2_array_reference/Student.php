...
class Student implements \JsonSerializable, \PSX\Record\RecordableInterface
{
    ...
    protected ?StudentArrayReference $properties = null;
    ...
    public function setProperties(?StudentArrayReference $properties) : void
    {
        $this->properties = $properties;
    }
    public function getProperties() : ?StudentArrayReference
    {
